      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-[#6B7280] mb-10 max-w-2xl mx-auto leading-relaxed">
            Project VISKOM MBG membantu mahasiswa dan pelajar tetap fokus selama
            sesi belajar online dengan timer Pomodoro dan monitoring AI yang
            supportive.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#6B7280] max-w-2xl mx-auto">
              Semua yang kamu butuhkan untuk menjaga fokus dan produktivitas
              belajar
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-[#6B7280] leading-relaxed">
                Teknik Pomodoro klasik dengan durasi 25 menit fokus dan 5 menit
                istirahat, membantu kamu tetap produktif tanpa burnout.
              </p>
            </Card>
            ...
            <Card className="hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-[#6B7280] leading-relaxed">
                Lihat statistik fokus, jumlah distraksi, dan persentase
                produktivitas untuk evaluasi diri yang lebih baik.
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-[#6B7280] leading-relaxed">
                AI monitoring akan memantau fokus kamu secara visual. Jika
                terdistraksi, akan ada gentle reminder untuk kembali fokus.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#6B7280] leading-relaxed">
                Setelah sesi selesai, lihat ringkasan fokus, distraksi yang
                terdeteksi, dan statistik produktivitas kamu.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              <div>
                <h3 className="font-semibold">Project VISKOM MBG</h3>
                <p className="text-sm text-white/70">AI-Powered Study Timer</p>
              </div>
            </div>

            <div className="text-center md:text-right">
              <p className="text-sm text-white/70">Created with Love</p>
